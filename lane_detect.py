...
def Detect_line_segment(cropped_edges):
    ...
    min_line_length = 25
    max_line_gap = 50
    line_segments = cv2.HoughLinesP(cropped_edges, rho, angle, min_threshold, np.array([]), min_line_length,
                                    max_line_gap)
...
def stabilize_steering_angle(curr_steering_angle, new_steering_angle, num_of_lane_lines,
                             max_angle_deviation_two_lanes=5, max_angle_deviation_one_lane=1):
